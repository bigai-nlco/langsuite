...
from langsuite.envs.teach.libs.teach.dataset.definitions import Definitions
from langsuite.envs.teach.libs.teach.dataset.task import Task
from langsuite.envs.teach.libs.teach.dataset.task_THOR import Task_THOR


class Dataset:
    def __init__(
        self, task_type=None, definitions=None, comments="", version=None, tasks=None
    ):
        self.version = "2.0" if version is None else version
        self.task_type = task_type
        self.comments = comments
        self.definitions = (
            Definitions(definitions=definitions, version=version)
    ...
    @classmethod
    def from_dict(
        cls, dataset_dict, process_init_state=True, version="2.0"
    ) -> "Dataset":
    ...
    @classmethod
    def import_json(
        cls, file_name, process_init_state=True, version="2.0"
    ) -> "Dataset":
