...
from langsuite.envs.teach.libs.teach import meta_data_files as meta_data_files
from langsuite.envs.teach.libs.teach.dataset.task_THOR import Task_THOR
from langsuite.envs.teach.libs.teach.meta_data_files import task_definitions
