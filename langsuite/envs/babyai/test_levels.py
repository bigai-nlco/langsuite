...
RegisteredEnvList = [
    {
        "id": "BabyAI-TestGoToBlocked-v0",
        "entry_point": "langsuite.envs.babyai.test_levels:Level_TestGoToBlocked",
    },
    {
        "id": "BabyAI-TestPutNextToBlocked-v0",
        "entry_point": "langsuite.envs.babyai.test_levels:Level_TestPutNextToBlocked",
    },
    {
        "id": "BabyAI-TestPutNextToCloseToDoor1-v0",
        "entry_point": "langsuite.envs.babyai.test_levels:Level_TestPutNextToCloseToDoor1",
    },
    {
        "id": "BabyAI-TestPutNextToCloseToDoor2-v0",
        "entry_point": "langsuite.envs.babyai.test_levels:Level_TestPutNextToCloseToDoor2",
    },
    {
        "id": "BabyAI-TestPutNextToIdentical-v0",
        "entry_point": "langsuite.envs.babyai.test_levels:Level_TestPutNextToIdentical",
    },
    {
        "id": "BabyAI-TestUnblockingLoop-v0",
        "entry_point": "langsuite.envs.babyai.test_levels:Level_TestUnblockingLoop",
    },
    {
        "id": "BabyAI-TestPutNextCloseToDoor-v0",
        "entry_point": "langsuite.envs.babyai.test_levels:Level_TestPutNextCloseToDoor",
    },
    {
        "id": "BabyAI-TestLotsOfBlockers-v0",
        "entry_point": "langsuite.envs.babyai.test_levels:Level_TestLotsOfBlockers",
    }
]
