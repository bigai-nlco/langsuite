...
class RegexOutputParser(OutputParser):
    ...
    ALFRED_ACTION_REGEX1 = r"(move_ahead|turn_left|turn_right|stop|pick_up|drop|toggle_on|toggle_off|put|slice|open|close)[\s\[]*(?:([a-zA-Z\|_]*_[0-9])*[\s,]*([a-zA-Z\|_]*_[0-9]))?"
    REARRANGE_ACTION_REGEX = r"(move_ahead|turn_left|turn_right|stop|pick_up|pickup|drop|open|close)[\s\[]*([a-zA-Z\|_]*_[0-9])?"
